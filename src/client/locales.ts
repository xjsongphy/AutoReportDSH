...
export const zh: Record<AutoReportLocaleKey, string> = {
  ...
  python: 'Python 环境',
  pythonHint: '选中 AutoReport 托管环境时才会用 uv 在 DSH home 下创建 venv 并安装 numpy/scipy/pandas/matplotlib。未选择不占空间。删除 $DSH_HOME/autoreport/venv 即可回收；再选托管会重新创建。也可选本机 conda/venv/pyenv/PATH 或自定义路径。模型、提供方和推理力度请在对话窗口用 DSH 自己的切换。',
  pythonPick: '请选择环境',
